...
const Meal1Single = ({route, navigation}) => {
  ...
  console.log(totalMeal1Calorie, 'total sum');

  // Format the number to always show 2 decimal places
  const formattedTotalCalorie = totalMeal1Calorie.toFixed(2);
      ...
      <Block
        ...
        <CircularProgress
          ...
          circleBackgroundColor={
            totalMeal1Calorie > data.calories * 0.2
              ? 'lightcoral'
              : '#353353'
          }
          title={
